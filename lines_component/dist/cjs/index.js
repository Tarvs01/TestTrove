...
function $ae672f8a57332157$export$5c92df8ce16beba9(props) {
    ...
    return /*#__PURE__*/ (0, $grpOf$reactjsxdevruntime.jsxDEV)((0, $bbbe352e17fce460$export$b18e34ac3520f2e5).Provider, {
        value: ctxVal,
        children: children
    }, void 0, false, {
...
function $5adf053b231d65df$export$775ba819c8141467(props) {
   ...
   */ const handleStartInteracting = (0, $grpOf$react.useCallback)(()=>{
    ...
    return (0, $grpOf$react.useMemo)(()=>/*#__PURE__*/ (0, $grpOf$reactjsxdevruntime.jsxDEV)("svg", {
            style: $5adf053b231d65df$var$SVG_STYLE,
            children: [
                colors?.map((c)=>/*#__PURE__*/ (0, $grpOf$reactjsxdevruntime.jsxDEV)("defs", {
                        children: /*#__PURE__*/ (0, $grpOf$reactjsxdevruntime.jsxDEV)("marker", {
                            id: `triangle-${c}`,
                            markerHeight: "5",
                            ...
                            refY: "5",
                            viewBox: "0 0 10 10",
                            children: /*#__PURE__*/ (0, $grpOf$reactjsxdevruntime.jsxDEV)("path", {
                ...
                pointsData?.map((p)=>{
                    return /*#__PURE__*/ (0, $grpOf$reactjsxdevruntime.jsxDEV)("path", {
                        id: `${p?.fromId}-${p?.toId}`,
                        d: p?.d,
                        fill: "none",
...
function $0295f77677accdeb$var$ConnectProviderInner() {
    ...
    return /*#__PURE__*/ (0, $grpOf$reactjsxdevruntime.jsxDEV)((0, $5adf053b231d65df$export$775ba819c8141467), {
        elements: elements
    }, void 0, false, {
...
function $0295f77677accdeb$export$230737e70939b618(props) {
    const { children: children  } = props;
    return /*#__PURE__*/ (0, $grpOf$reactjsxdevruntime.jsxDEV)((0, $ae672f8a57332157$export$5c92df8ce16beba9), {
        children: [
            children,
            /*#__PURE__*/ (0, $grpOf$reactjsxdevruntime.jsxDEV)($0295f77677accdeb$var$ConnectProviderInner, {}, void 0, false, {
                fileName: "ConnectProvider.tsx",
                lineNumber: 21,
                columnNumber: 7
            }, this)
